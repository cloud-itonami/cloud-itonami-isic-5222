# Operator Quickstart — Community Port Authority and Harbor Operations

Shortest path from clone to a verified local dry-run for **ISIC 5222** (`cloud-itonami-isic-5222`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-5222.git
cd cloud-itonami-isic-5222
```
...
- Blueprint governor key: `port-authority-governor`
- Likely source path: `src/**/port-authority-governor.cljc`
